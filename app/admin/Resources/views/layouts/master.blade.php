...
<head>
    ...
    <link href="{{asset('/css/web/css/own_profile.css')}}" rel="stylesheet">
    <link href="{{asset('/css/web/css/own_profile_detail.css')}}" rel="stylesheet">
    <link href="{{asset('/css/web/css/index.css')}}" rel="stylesheet">
    <link href="{{asset('/css/web/css/include/form.css')}}" rel="stylesheet">
    <link href="{{asset('/css/web/css/include/header.css')}}" rel="stylesheet">
    <link href="{{asset('/css/web/css/products.css')}}" rel="stylesheet">
    <!-- <link href="{{asset('/css/web/css/account_ads.css')}}" rel="stylesheet"> -->
    <!-- <link href="{{asset('/css/web/css/account_profile.css')}}" rel="stylesheet"> -->
    <!-- <link href="{{asset('/css/web/css/message.css')}}" rel="stylesheet"> -->
    <!-- <link href="{{asset('/css/web/css/place_ads.css')}}" rel="stylesheet"> -->
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" target="_blank" href="{{ url('/') }}">Open website <i class="fa fa-external-link" aria-hidden="true"></i></a>
      </li>
    </ul>
